			...
			<div class="cmain aboutus">
					...
					<ul class="abc_left fl">
						<li><h3>-关于我们-</h3>
							<ul class="abul_ul" >
                                ...
                                <li class="bau_other">
                                    <h4>
                                        <a  href="swhz.jsp" class="specl_other">>商务合作</a>
                                    </h4>
                                </li>
                                <li class="bau_other">
                                    <h4>
				...
				<!--左边结束-->
						...
						<div class="abcr_center">
							...
							<div id="content">
								<div>&nbsp;</div>
								<div>Darry Ring&trade; 作为戴瑞珠宝Darry
									Jewelry所拥有的求婚钻戒品牌，经过多年的发展，已经在国际上获得了广泛的知名度，在中国港澳与大陆地区，也拥有为数众多的喜爱者。</div>
								<div>
									<br> 中国大陆地区实体销售门店位于：深圳，北京，上海，重庆，广州，预计将会覆盖中国各大重要核心城市。
								</div>
								<div>&nbsp;</div>
								<div>精准定位于求婚钻戒产品，在奉上精美钻饰产品的同时，不断的为客户带来幸福与甜蜜的体验，是Darry
									Ring&trade;品牌不懈努力的目标。</div>
								<div>
									<br> 我们愿与致力为甜蜜爱情与恋人的终身幸福贡献力量的企业合作，欢迎有相同目标的品牌共同努力。<br> <br>
									&nbsp; 合作方向：<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 1.
									媒体与市场推广活动。<br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2.
									婚庆，婚恋相关产品与服务配套<br> <br> &nbsp; 商务/媒体：0755-86727225<br>
									&nbsp;&nbsp; 邮箱：dr@darryring.com<br> &nbsp;&nbsp;
									(周一至周五：9:00-18:30)<br> &nbsp;
								</div>
							</div>
						</div>
