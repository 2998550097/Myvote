				...
				<div class="about_center">
					<ul class="abc_left fl">
						...
						<li><h3>-服务条款-</h3>
							<ul class="abul_ul" >
								<li class="bau_other">
									<h4><a href="xgsc.jsp" >>修改手寸 </a></h4>
								</li>
							 	<li class="bau_other">
							  		<h4><a href="zsby.jsp">>终生保养 </a></h4>
								</li>
							 	<li class="bau_other">
									<h4><a href="yzsz.jsp">>一钻双证 </a> </h4>
								</li>
								<li class="bau_other">
							 		<h4><a href="zsgh.jsp" >>钻石更换 </a></h4>
								</li>
								<li class="bau_other">
									 <h4> <a  href="qcbx.jsp" class="specl_other">>全程保险 </a></h4>
								</li>
								<li class="bau_other">
									<h4><a href="gh15.jsp">>15天退换</a></h4>
							 	</li>
							 	<li class="bau_other">
							 		<h4> <a  href="zcxy.jsp">>注册协议 </a></h4>
								</li>
							 	<li class="bau_other">
							  		<h4><a href="yssm.jsp">>隐私声明</a></h4> 
							 	</li>
							</ul>
