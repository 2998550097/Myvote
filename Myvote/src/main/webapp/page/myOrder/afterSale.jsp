...
<html>
	...
	<jsp:include page="../../page/nav.jsp"/>
		                    ...
		                    <div class="member_all-nav">
		                    	<div class="member_all-nav-top">
		                            ...
		                            <div class="member_all-nav-right fr">
		                            	<i class="member_tz"></i>
		                                <span>网站办理售后功能推出，如遇到售后问题，请及时联系<a target="_blank" style="cursor: pointer" onclick="javascript:showxiaon();">
		                                在线客服</a>！</span>
		                            </div>
		                        </div>
		                        <!--黄色线-->
		...
		<p>2.自商品签收之日起，Darry Ring按照商品属性为您提供售后服务。</p>
		                            ...
		                            <!--售后的表格-->
		                            <table cellspacing="0" cellpadding="0" border="0" class="member_service-table">
		                        ...
		                        <!--办理售后end-->
		                        <!--售后记录-->
		                        <div style="display:none" class="member_service-custre member_news-it">
		                        	<!--售后记录的表格-->
		                            <table cellspacing="0" cellpadding="0" border="0" class="member_service-tablejl">
		                            	<tbody><tr class="service-tablejl-trfirst">
