...
<html>
	<head>
		...
		<title>DR族粉丝社区</title>
		<link rel="stylesheet" type="text/css" href="DR/css/index.css">
		<link rel="stylesheet" type="text/css" href="css/kefu.css">
		<link rel="stylesheet" type="text/css" href="DR/css/info.css">
		<link rel="stylesheet" type="text/css" href="DR/css/common.css">
		...
		<script type="text/javascript" src="DR/js/tools.js"></script>
		<script type="text/javascript" src="DR/js/banner.js"></script>
		<script type="text/javascript" src="DR/js/common.js"></script>
		<script type="text/javascript" src="DR/js/index.js"></script>
