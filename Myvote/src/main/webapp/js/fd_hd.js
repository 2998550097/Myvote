...
/*对戒点击切换*/
$(function () {
    $('.thealldj').click(function () {
        $('.theman_djsc,.thewoman_djsc,.theman_djkz,.thewoman_djkz').show();
    });
    $('.themandj').click(function () {
        $('.theman_djsc,.theman_djkz').show();
        $('.thewoman_djsc,.thewoman_djkz').hide();
    });
    $('.thewomandj').click(function () {
        $('.theman_djsc,.theman_djkz').hide();
        $('.thewoman_djsc,.thewoman_djkz').show();
    });
})