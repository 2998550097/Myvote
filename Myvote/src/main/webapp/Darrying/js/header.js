...
define(function (require, exports, module) {
    /*通过 require 引入依赖*/
    alert(111);
    require('Darrying/js/jquery.js');
    var drToggle = require('Darrying/js/drtoggle.js');
    var Tabs = require('Darrying/js/tabs.js');
    var Banner_nav = require('Darrying/js/banner.js');
    var twoTabs = require('Darrying/js/twoTabs.js');
